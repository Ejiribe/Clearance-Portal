...
const server = http.createServer((req, res) => {
  ...
  if (req.method === 'GET' && reqUrl.pathname === '/ao-email') {
    const aoEmail = {
      '1234567890': 'ao1@email.com',
      '4567890123': 'ao2@email.com',
      '7890123456': 'ao3@email.com',
      '0123456789': 'ao4@email.com'
    }
    res.end(JSON.stringify(aoEmail));
  }
